export const metadata = {
  title: 'Snooze: Ultra-Minimal Webserver for Kubernetes | Testing & Debugging',
...
### Scenario 1: Microservices Development Placeholder
...
### Scenario 2: Debugging Ingress Routing Issues
...
### Example 1: Custom Port and Message (Environment Variables)
...
### Example 2: Command-Line Flags Override
...
### Example 3: HTML Content via ConfigMap
...
### 3. Use ConfigMaps for Dynamic Content
...
A: Snooze starts in <1 second (cached image). From `kubectl apply` to first successful request typically takes 1-3 seconds.
...
### 1. Testing Kubernetes Networking
