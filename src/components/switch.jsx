...
const colors = {
  ...
  red: [
    '[--switch-bg-ring:var(--color-red-600)]/90 [--switch-bg:var(--color-red-500)] dark:[--switch-bg-ring:transparent]',
    '[--switch:white] [--switch-ring:var(--color-red-600)]/90 [--switch-shadow:var(--color-red-900)]/20',
  ],
  teal: [
